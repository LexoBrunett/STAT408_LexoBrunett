setwd("C:/Users/mxi1/OneDrive - Loyola University Chicago/Loyola/STAT 408 Fall 2023")
...
F.original <- summary(lm.model)$fstat[1]; F.original
...
T.original <- abs(summary(lm.model)$coef[5,3])
...
for(i in 1:1000){
  ...
  Ts[i] <-  abs(summary(lm.model)$coef[5,3])
}
